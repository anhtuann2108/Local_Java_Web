...
public class FormRegister extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		printWriter.println("<form action='/Section_04/register' method='POST'>");
		printWriter.println("<div class='container'>");
		printWriter.println("<label><b>Email</b></label>");
		printWriter.println("<input type='email' placeholder='Enter Email' name='email' required>");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		printWriter.println("Create Successfully! <a href='/Section_04/login'>Login</a>");
	}
}
