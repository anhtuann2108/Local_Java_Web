...
<body>
	...
	<h1><a href="/Section_08_MVC/admin/addUser">Add User</a></h1>
	<h1><a href="/Section_08_MVC/admin/addProduct">Add Product</a></h1>
	<h1><a href="/Section_08_MVC/admin/product-detail">Product Detail</a></h1>
